#Author: Ahmed (DaZR95)
#This program is for educational purposes only, please use this program ethically!
import json
...
def phoneGW():
    User_phone = input(
        f"\n {Wh}Enter phone number target {Gr}Ex [+2012xxxxxxxxx] {Wh}: {Gr}")  # INPUT NUMBER PHONE
...
def option():
    ...
    stderr.writelines(f"""
 _____               _         __  __           _            
|_   _| __ __ _  ___| | __    |  \/  | __ _ ___| |_ ___ _ __ 
  | || '__/ _` |/ __| |/ /____| |\/| |/ _` / __| __/ _ \ '__|
  | || | | (_| | (__|   <_____| |  | | (_| \__ \ ||  __/ |   
  |_||_|  \__,_|\___|_|\_\    |_|  |_|\__,_|___/\__\___|_|  

        {Wh}[ + ]  C O D E   B Y   D A Z R 9 5  [ + ]          
    """)
...
def run_banner():
    ...
    stderr.writelines(f"""{Wh}
         .-.
       .'   `.          {Wh}--------------------------------
       :g g   :         {Wh}| {Gr}TracksMaster - IP ADDRESS    {Wh}|
       : o    `.        {Wh}|       {Gr}@CODE BY DaZR95        {Wh}|
      :         ``.     {Wh}--------------------------------
     :             `.
    :  :         .   `.
    :   :          ` . `.
